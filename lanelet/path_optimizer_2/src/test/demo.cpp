...
int main(int argc, char **argv) {
    ...
    // {
    //     for(int j = 0; j < obsdata.cols(); ++j)
    //     {
    //         std::cout << obsdata(i, j) << " ";
    //     }
    //     std::cout << std::endl;
    // }
//    cv::imwrite("/home/ljn/桌面/map1.png", eigen2cv(grid_map.get("obstacle")));
    ...
    // grid_map::GridMapRosConverter::fromOccupancyGrid(message, "obstacle", grid_map);
    ...
    while (nh.ok()) {
        ...
        // grid_map::GridMapRosConverter::toOccupancyGrid(
        //     grid_map, "obstacle", 0, 100, message);
