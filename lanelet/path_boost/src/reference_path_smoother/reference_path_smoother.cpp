...
#include "path_boost/reference_path_smoother/tension_smoother_2.hpp"
...
bool ReferencePathSmoother::solve(std::shared_ptr<PathBoostNS::ReferencePath> reference_path) {
...
double ReferencePathSmoother::getG(const PathBoostNS::APoint &point,
                                   const PathBoostNS::APoint &parent) const {
    // Obstacle cost.
...
bool ReferencePathSmoother::graphSearchDp(std::shared_ptr<PathBoostNS::ReferencePath> reference) {
    auto t1 = std::clock();
    ...
    BState proj_point(x_s(vehicle_s), y_s(vehicle_s), getHeading(x_s, y_s, vehicle_s));
...
bool ReferencePathSmoother::graphSearch(std::shared_ptr<PathBoostNS::ReferencePath> reference) {
    auto t1 = std::clock();
...
bool ReferencePathSmoother::postSmooth(std::shared_ptr<PathBoostNS::ReferencePath> reference_path) {
...
ReferencePathSmoother::ReferencePathSmoother(const std::vector<BState> &input_points,
                                             const BState &start_state,
                                             const Map &grid_map) :
