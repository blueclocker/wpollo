...
TensionSmoother::TensionSmoother(const std::vector<PathBoostNS::BState> &input_points,
                                 const PathBoostNS::BState &start_state,
                                 const PathBoostNS::Map &grid_map) :
    ReferencePathSmoother(input_points, start_state, grid_map) {}

bool TensionSmoother::smooth(std::shared_ptr<PathBoostNS::ReferencePath> reference_path) {
