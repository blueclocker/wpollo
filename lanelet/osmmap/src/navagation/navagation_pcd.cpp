 ...
 * @Date: 2022-11-06 19:33:13
 * @LastEditTime: 2022-11-06 21:41:57
 * @LastEditors: blueclocker 1456055290@hnu.edu.cn
 * @Description: 
 * @FilePath: /wpollo/src/lanelet/osmmap/src/navagation/navagation_pcd.cpp
 * Copyright (c) 2022 by bit, All Rights Reserved. 
 */
#include "navagation/navagation_pcd.h"

namespace navagation
{
NavagationPcd::NavagationPcd(ros::NodeHandle &n) : NavagationBase(n)
{
    gps_sub_ = n_.subscribe("/mapping_odometry", 1, &NavagationPcd::PcdCallback, this);
}

void NavagationPcd::PcdCallback(const nav_msgs::Odometry::ConstPtr &msg)
{
    //点云配准
...
void NavagationPcd::Process()
{
    ROS_INFO("\033[1;32m --> PCD mode is working ...  \033[0m\n");
    //main loop
    ros::Rate r(10);
    while(n_.ok())
    {
