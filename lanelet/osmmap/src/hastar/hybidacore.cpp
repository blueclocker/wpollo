 ...
 * @LastEditTime: 2022-09-12 14:26:11
 * @LastEditors: blueclocker 1456055290@hnu.edu.cn
 * @Description: 
 * @FilePath: /wpollo/src/lanelet/osmmap/src/plan/hybidacore.cpp
...
void hybidacore::init(const nav_msgs::OccupancyGridConstPtr &current_costmap_ptr_, double map_grid_resolution)
{
