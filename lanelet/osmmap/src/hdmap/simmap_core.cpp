 ...
 * @LastEditTime: 2022-11-02 15:45:53
...
HDMap::HDMap(ros::NodeHandle n):n_(n)
{
    ...
    gps_sub_ = n_.subscribe("/odom", 1, &HDMap::GpsCallback, this);
    //main loop
    ros::Rate r(10);
    while(n_.ok())
    {
...
void HDMap::GpsCallback(const nav_msgs::Odometry::ConstPtr &msg)
{
    ...
    if(use_gnss_)
    {
        ...
        //点云配准
        // x: 0.0135536137968302
        // y: 0.00340890442021191
        // z: -0.792365729808807
        // w: 0.609886348247528
    ...
    if(use_gnss_)
    {
        ...
        qenu2base.setY(q.y());
        qenu2base.setZ(q.z());
        geometry_msgs::Quaternion localq;
