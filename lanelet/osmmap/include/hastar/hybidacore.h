 ...
 * @LastEditTime: 2022-09-08 20:39:09
 * @FilePath: /catkin_ws/src/hastar/include/hastar/hybidacore.h
...
public:
    ...
    ~hybidacore();
    void init(const nav_msgs::OccupancyGridConstPtr &current_costmap_ptr_, double map_grid_resolution);
