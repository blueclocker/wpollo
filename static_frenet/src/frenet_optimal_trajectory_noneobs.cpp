...
// from test_msgs.msg import Test//pathpoint
// from fsd_common_msgs.msg import Gnss//yaw
//road left&right width
...
//路点的回调函数，两个问题，返回值类型可以非空吗，回调函数间可以嵌套吗？
//vector<Vec_f,i>
void callback(const rs_perception::PerceptionListMsg::ConstPtr &obs_data,
              const visualization_msgs::MarkerArray::ConstPtr &path_data,
              const nav_msgs::Odometry::ConstPtr &gps_data,
              const sensor_msgs::Imu::ConstPtr &acc_data,
              const fsd_common_msgs::Gnss::ConstPtr &yaw_data)
{
  //定义目标速度
  ...
  for (size_t j = 0; j < path_data->markers[1].points.size(); ++j)
  {
    wx.push_back(path_data->markers[1].points[j].x);
    wy.push_back(path_data->markers[1].points[j].y);
  }

  // //版本更改，注释起始点
  // //障碍物设定，目前一共有6个
  // std::vector<int> num_vertices_obstcle;
  // num_vertices_obstcle.push_back(4);
  // num_vertices_obstcle.push_back(4);
  //   // int num_vertices_obstcle_1 = 4;
  //   // int num_vertices_obstcle_2 = 4;
  //   // int num_vertices_obstcle_3 = 4;
  //   // int num_vertices_obstcle_4 = 4;
  //   // int num_vertices_obstcle_5 = 4;
  //   //  int num_vertices_obstcle_6 = 5;
  //   // int num_vertices_obstcle_7 = 3;
  //   // int num_vertices_obstcle_8 = 5;
  //   // int num_vertices_obstcle_9= 3;
  //   std::vector<Vector2D*> vector_obstcle;
  //   Vec_f*vector_obstcle_center  =  new Vec_f ;
  //   for (int k = 0;k<num_vertices_obstcle.size();k++)
  //   {

  //     Vector2D *vector_obstcle_1 = new Vector2D[num_vertices_obstcle[k]];
  // //   Vector2D *vector_obstcle_2 = new Vector2D[num_vertices_obstcle_2];
  // //   Vector2D *vector_obstcle_3 = new Vector2D[num_vertices_obstcle_3];
  // //   Vector2D *vector_obstcle_4 = new Vector2D[num_vertices_obstcle_4];
  // //   Vector2D *vector_obstcle_5 = new Vector2D[num_vertices_obstcle_5];
  // // Vector2D *vector_obstcle_6 = new Vector2D[num_vertices_obstcle_6];
  // // Vector2D *vector_obstcle_7 = new Vector2D[num_vertices_obstcle_7];
  // // Vector2D *vector_obstcle_8 = new Vector2D[num_vertices_obstcle_8];
  // // Vector2D *vector_obstcle_9 = new Vector2D[num_vertices_obstcle_9];
  //   vector_obstcle_1[0] = Vector2D(50.0+10*k, -2.0);
  //   vector_obstcle_1[1] = Vector2D(54.0+10*k, -2.0);
  //   vector_obstcle_1[2] = Vector2D(54.0+10*k, 2);
  //   vector_obstcle_1[3] = Vector2D(50.0+10*k,2);
  //   vector_obstcle_center->push_back(50+10*k);
  //   vector_obstcle.push_back(vector_obstcle_1);
  //   }
  // //版本更改，注释结束点
  ...
  // Vec_f*vector_obstcle_center  =  new Vec_f ;
  // //生成障碍物信息容器
  // Vector2D *vector_obstcle_1 = new Vector2D[num_vertices_obstcle[0]];
  // Vector2D *vector_obstcle_2 = new Vector2D[num_vertices_obstcle[1]];
  // Vector2D *vector_obstcle_3 = new Vector2D[num_vertices_obstcle[2]];
  // Vector2D *vector_obstcle_4 = new Vector2D[num_vertices_obstcle[3]];
  // Vector2D *vector_obstcle_5 = new Vector2D[num_vertices_obstcle[4]];
  // Vector2D *vector_obstcle_6 = new Vector2D[num_vertices_obstcle[5]];
  //   Vector2D *vector_obstcle_3 = new Vector2D[num_vertices_obstcle_3];
  //   Vector2D *vector_obstcle_4 = new Vector2D[num_vertices_obstcle_4];
  //   Vector2D *vector_obstcle_5 = new Vector2D[num_vertices_obstcle_5];
  // Vector2D *vector_obstcle_6 = new Vector2D[num_vertices_obstcle_6];
  ...
  //障碍物点的信息
  // vector_obstcle_1[0] = Vector2D(50.0, 0.4);
  // vector_obstcle_1[1] = Vector2D(54.0, 0.4);
  // vector_obstcle_1[2] = Vector2D(54.0, 2.7);
  // vector_obstcle_1[3] = Vector2D(50.0,2.7);

  // vector_obstcle_2[0] = Vector2D(56.0, 0.5);
  // vector_obstcle_2[1] = Vector2D(60.0, 0.5);
  // vector_obstcle_2[2] = Vector2D(60.0, 2.5);
  // vector_obstcle_2[3] = Vector2D(56.0, 2.5);

  // vector_obstcle_3[0] = Vector2D(65.0, 2);
  // vector_obstcle_3[1] = Vector2D(69.0, 2);
  // vector_obstcle_3[2] = Vector2D(69.0, 2.2);
  // vector_obstcle_3[3] = Vector2D(65.0, 2.2);

  // vector_obstcle_4[0] = Vector2D(75, 2.5);
  // vector_obstcle_4[1] = Vector2D(79.0, 2.5);
  // vector_obstcle_4[2] = Vector2D(79.0, 3.5);
  // vector_obstcle_4[3] = Vector2D(75.0, 3.5);

  // vector_obstcle_5[0] = Vector2D(90, -2);
  // vector_obstcle_5[1] = Vector2D(94, -2);
  // vector_obstcle_5[2] = Vector2D(94, -0.5);
  // vector_obstcle_5[3] = Vector2D(90, -0.5);

  // vector_obstcle_6[0] = Vector2D(120, -2);
  // vector_obstcle_6[1] = Vector2D(121, -2);
  // vector_obstcle_6[2] = Vector2D(121, 6);
  // vector_obstcle_6[3] = Vector2D(120, 6);

  // vector_obstcle_7[0] = Vector2D(80, -2);
  // vector_obstcle_7[1] = Vector2D(84, -5);
  // vector_obstcle_7[2] = Vector2D(77, -3);

  // vector_obstcle_8[0] = Vector2D(89, 0);
  // vector_obstcle_8[1] = Vector2D(91, -3);
  // vector_obstcle_8[2] = Vector2D(92, -0.3);
  // vector_obstcle_8[3] = Vector2D(92, 0.4);
  // vector_obstcle_8[4] = Vector2D(90, 2);

  // vector_obstcle_9[0] = Vector2D(81, 3);
  // vector_obstcle_9[1] = Vector2D(89, 4);
  // vector_obstcle_9[2] = Vector2D(82, 4.4);

  // //存放障碍物筛选依据（这里取障碍物x坐标位置）
  // vector_obstcle_center->push_back(50);
  // vector_obstcle_center->push_back(56);
  // vector_obstcle_center->push_back(65);
  // vector_obstcle_center->push_back(75);
  // vector_obstcle_center->push_back(90);
  // vector_obstcle_center->push_back(120);

  // //将障碍物存放到障碍物列表里
  // vector_obstcle.push_back(vector_obstcle_1);
  // vector_obstcle.push_back(vector_obstcle_2);
  // vector_obstcle.push_back(vector_obstcle_3);
  // vector_obstcle.push_back(vector_obstcle_4);
  // vector_obstcle.push_back(vector_obstcle_5);
  // vector_obstcle.push_back(vector_obstcle_6);

  // //碰撞检测障碍物表
  //   Polygon_list obstcles_list;
  // for(int k = 0;k<num_vertices_obstcle.size();k++)
  // {
  //   if( ((vector_obstcle_center[k][0]>=s0)&&(vector_obstcle_center[k][0]-s0<=30))||  ((vector_obstcle_center[k][0]<s0)&&(s0-vector_obstcle_center[k][0]<5)) )
  //   obstcles_list .push_back(Polygon(num_vertices_obstcle[k], vector_obstcle[k])); //用于碰撞检测
  ...
  // obstcles_list_vertex.push_back({50,54,54,50});  //两个一组存放x，y
  // obstcles_list_vertex.push_back({0.4,0.4,2.7,2.7});

  // obstcles_list_vertex.push_back({56,60,60,56});  //两个一组存放x，y
  // obstcles_list_vertex.push_back({0.5,0.5,2.5,2.5});

  // obstcles_list_vertex.push_back({65,69,69,65});
  // obstcles_list_vertex.push_back({2,2,2.2,2.2});

  // obstcles_list_vertex.push_back( {75,79,79,75});
  // obstcles_list_vertex.push_back({2.5,2.5,3.5,3.5});

  // obstcles_list_vertex.push_back({90,94,94,90});
  // obstcles_list_vertex.push_back({-2,-2,-0.5,-0.5});

  // obstcles_list_vertex.push_back({120,121,121,120});
  // obstcles_list_vertex.push_back({-2,-2,6,6});

  // // obstcles_list_vertex.push_back({30,31,31,30});
  // // obstcles_list_vertex.push_back({8,8,11,11});

  // // obstcles_list_vertex.push_back({68,72,75,70,67});
  // // obstcles_list_vertex.push_back({4,3,3.5,5,5});

  // // obstcles_list_vertex.push_back({80,84,77});
  // // obstcles_list_vertex.push_back({-2,-5,-3});

  // // obstcles_list_vertex.push_back({89,90,92,92,90});
  // // obstcles_list_vertex.push_back({0,-3,-0.3,0.4,2});

  // // obstcles_list_vertex.push_back({81,89,82});
  // // obstcles_list_vertex.push_back({3,4,4.4});
  // }
  ...
  //初始信息
  float c_speed_x = gps_data->twist.twist.linear.x;
  float c_speed_y = gps_data->twist.twist.linear.y;
  float c_speed = sqrt(c_speed_x * c_speed_x + c_speed_y * c_speed_y);
  float c_x = gps_data->pose.pose.position.x;
  float c_y = gps_data->pose.pose.position.y;
  ...
  float x_goal_give = r_x.back(); //停车目标点
  float y_goal_give = r_y.back();
  ...
  // std::cout << "s = " << frenet_goal_point[0] << " , d = " << frenet_goal_point[1] << " , x = " <<  cartesian_goal_point[0] <<  " , y = " <<  cartesian_goal_point[1] << std::endl;
  ...
  for (int i = 0; i < SIM_LOOP; i++)
  {
    ...
    if (action == 0)
      std::cout << "意图为巡航" << std::endl;
    if (action == 1)
      std::cout << "意图为停车" << std::endl;

    // if (frenet_goal_point[0] -s0> 20 || frenet_goal_point[0] == 0 ){
    if (action == 0)
    {
      std::cout << "no_stopping     i=" << i << std::endl;
      final_path = frenet_optimal_planning_cruising(target_speed, csp_obj, s0, c_speed, c_d, c_d_d, c_d_dd, obstcles_list);
    }

    else if (action == 1)
    {
      std::cout << "get_stopping     i=" << i << std::endl;
      final_path = frenet_optimal_planning_stopping(target_speed, csp_obj, s0, c_speed, c_acc, c_d, c_d_d, c_d_dd, frenet_goal_point[0], frenet_goal_point[1], obstcles_list, last_path);
    ...
    if (final_path.s.empty() && last_path.s.size() > 2 && (count_last_path < 5))
    {
      ...
      else
      {
        ...
        alter_final_path = frenet_optimal_planning_stopping_noway(target_speed, csp_obj, s0, c_speed, c_acc, c_d, c_d_d, c_d_dd, last_path.s.back(), last_path.d.back(), obstcles_list, last_path);
    ...
    for (size_t j = 0; j < final_path.x.size(); ++j)
    {
      ...
      marker.header = path_data->markers[1].header;
      ...
      marker.color.b = 0.0;
      marker.color.r = 0.0;
      marker.points[j].x = final_path.x[j];
      marker.points[j].y = final_path.y[j];
    }
  ...
  // if ((std::pow((frenet_goal_point[0] - final_path_show.s[0]), 2) <= 0.5 && frenet_goal_point[0] != 0) || rs.back() - final_path_show.s[0] <= 2)
  // {
...
int main(int argc, char **argv)
{
  ...
  message_filters::Subscriber<rs_perception::PerceptionListMsg> obs_sub(nh, "rs_percept_result", 1);
  message_filters::Subscriber<visualization_msgs::MarkerArray> r_path_sub(nh, "path_points", 1);
  ...
  // ros::Subscriber obj_sub =  nh.subscribe<rs_perception::PerceptionListMsg>("rs_percept_result",1,&obj_callback，this)
  // ros::Subscriber r_path_sub = nh.subscribe<visualization_msgs::MarkerArray>("r_path",1,&r_path_callback,this);//.markers.points

  // TimeSynchronizer<rs_perception::PerceptionListMsg, visualization_msgs::MarkerArray, nav_msgs::Odometry, sensor_msgs::Imu, fsd_common_msgs::Gnss> sync(obs_sub, r_path_sub,gps_sub,acc_sub,yaw_sub,10);
  ...
  message_filters::Synchronizer<syncPolicy> sync(syncPolicy(10), obs_sub, r_path_sub, gps_sub, acc_sub, yaw_sub);
  sync.registerCallback(boost::bind(&callback, _1, _2, _3, _4, _5));

  ros::Publisher path_pub = nh.advertise<visualization_msgs::MarkerArray>("frenet_path", 1);
